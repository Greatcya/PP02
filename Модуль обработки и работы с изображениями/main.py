...
if todo == "1":
    ...
    path = input("Укажите путь или перетащите изображение и нажмите Энтер, затем напишите название для нового файла: ")
    ...
    path = input("Укажите путь или перетащите изображение и нажмите Энтер, затем напишите путь по которому нужно переместить файл: ")
